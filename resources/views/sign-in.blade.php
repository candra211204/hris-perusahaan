...
@section('content')
    <div class="card card-md">
        <div class="card-body">
            ...
            <form action="{{ route('sign.in.action') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label class="form-label">Email</label>
                    <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}"
                        name="email" placeholder="ex : example@email.com" autofocus required>
                    @error('email')
                    ...
                    <div class="input-group input-group-flat">
                        ...
                        <span class="input-group-text">
                            <a href="" class="link-secondary" title="Show password" data-bs-toggle="tooltip"
                                id="sign-in-show-password"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                ...
                <div class="mb-2">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Tetap login di perangkat ini</span>
                    </label>
                </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            $('#sign-in-show-password').click(function(e) {
                e.preventDefault();

                let pass = $("#sign-in-password");
